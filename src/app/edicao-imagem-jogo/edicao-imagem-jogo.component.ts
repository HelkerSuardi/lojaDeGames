...
import { Imagem } from '../edicao-lista-imagens-jogo/edicao-lista-imagens-jogo.component';

@Component({
    selector: 'app-edicao-imagem-jogo',
    templateUrl: './edicao-imagem-jogo.component.html',
    styleUrls: ['./edicao-imagem-jogo.component.scss']
})
export class EdicaoImagemJogoComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        if (this.imagem.url) {
            ...
            const nome = `${this.idJogo}_${new Date().getTime()}_${this.imagem.arquivo.name}`;
